...
const About = () => {
  return (
    <>
      ...
      <Card style={{ width: "100%",height:"100%",justifyContent:"center",textAlign:"center" }}>
        <Card.Header>
          <h1>The Generics</h1>
        </Card.Header>
        <Card.Body>
        ...
        <Card.Footer>
         <div style={{marginLeft:"-30rem"}}> <h1>The Generics</h1>
          <div style={{marginRight:"-60rem",marginTop:"-2.8rem"}}><span>icon 1</span>
          <span>icon 2</span>
          <span>icon 3</span></div></div>
        </Card.Footer>
      </Card>
    </>
  );
